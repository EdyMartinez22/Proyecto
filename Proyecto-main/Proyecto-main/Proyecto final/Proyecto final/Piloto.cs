namespace Proyecto_final
{
    internal class Piloto : Persona
    {
        ...
        public Piloto(int noempleado, string aerolinea_asignada, int aniodeexperiencia, string nombre, string apellido, int edad, string correo, string direccion, string identidad) :
            base(nombre, apellido, edad, correo, direccion, identidad)
        {
            Noempleado = noempleado;
            Aerolinea_asignada = aerolinea_asignada;
